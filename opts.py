...
def get_opts():
    ...
    parser.add_argument("--traj_model", type=bool, default=False, help="[True | False]")
    parser.add_argument(
    ...
    parser.add_argument("--test_freq", type=int, default=10, help="frequency of test")
    parser.add_argument("--print_freq", type=int, default=10, help="frequency of print")
    parser.add_argument(
        "--persist_dataloader",
        type=bool,
        default=True,
